...
QT_MOC_LITERAL(1, 14, 15), // "playlistChanged"
QT_MOC_LITERAL(2, 30, 0), // ""
QT_MOC_LITERAL(3, 31, 7), // "getSong"
QT_MOC_LITERAL(4, 39, 5), // "Song*"
QT_MOC_LITERAL(5, 45, 5), // "index"
QT_MOC_LITERAL(6, 51, 8), // "playlist"
QT_MOC_LITERAL(7, 60, 12) // "QList<Song*>"

    },
    "PlaylistModel\0playlistChanged\0\0getSong\0"
    "Song*\0index\0playlist\0QList<Song*>"
};
...
void PlaylistModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: { Song* _r = _t->getSong((*reinterpret_cast< int(*)>(_a[1])));
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&PlaylistModel::playlistChanged)) {
                *result = 0;
                return;
            }
        }
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: *reinterpret_cast< QList<Song*>*>(_v) = _t->playlist(); break;
        default: break;
        }
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: _t->setPlaylist(*reinterpret_cast< QList<Song*>*>(_v)); break;
        default: break;
        }
